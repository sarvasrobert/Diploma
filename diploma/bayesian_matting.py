...
def bayesian_matte(img, trimap, sigma=16, N=25, minN=10):   # povodne bolo sigma=8, N=25, minN=10
    img = img/255
    ...
    while n < nUnknown:
        ...
        for i in range(Y.shape[0]):
            ...
            f, b, alphaT = solve(mu_f, sigma_f, mu_b, sigma_b, p, 0.01, alpha_init, 100, 1e-6)
